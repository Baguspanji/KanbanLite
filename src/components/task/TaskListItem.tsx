      ...
      {(provided, snapshot) => (
        ...
        >
          ...
          <div className="flex-grow min-w-0 py-1">
            <h3 className="font-medium break-words text-sm sm:text-base">{task.title}</h3>
            {task.description && (
              <p className="text-xs text-muted-foreground line-clamp-1 sm:line-clamp-2 break-words mt-0.5" title={task.description}>
                {task.description}
              </p>
            )}
